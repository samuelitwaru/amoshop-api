...
# load api resources
from app.API.resources.product import ProductAPI, ProductListAPI
...
from app.API.resources.user import UserAPI, UserListAPI, UserAuthAPI, UserUpdateAPI, UserSessionAPI
# from app.API.resources.session import SessionAPI, SessionListAPI
...
# api.add_resource(UserSessionAPI, '/shop/api/v1.0/users/<int:user_id>/session', endpoint="user_session")

# api.add_resource(SessionListAPI, '/shop/api/v1.0/sessions', endpoint="sessions")
# api.add_resource(SessionAPI, '/shop/api/v1.0/sessions/<int:id>', endpoint="session")
